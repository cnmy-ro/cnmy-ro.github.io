...
- Any evidence supports a hypothesis only deductively, i.e. so far as the general hypothesis explains the local measurement. Beyond the scope of the evidence, nothing can be said about the truth of our hythothesis, except when considering also the surprise towards the source of this evidence and the chance of falsification of our hypothesis despite this evidence. These latter two factors are, in a sense, on a level above the evidence itself, and they depend on the background knowledge of the agent that does the investigation, for e.g. its understanding of the limits of its hypothesis and of its experimental setup.
